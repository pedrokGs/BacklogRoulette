...
class TooManyRequestsException extends AuthException {
  TooManyRequestsException([
    super.message = 'Muitas tentativas. Tente novamente mais tarde.',
  ]);
}
...
class UserNotFoundException extends AuthException {
  UserNotFoundException([
    super.message = 'Nenhum usuário encontrado para este e-mail.',
  ]);
}
...
class InvalidPasswordException extends AuthException {
  InvalidPasswordException([
    super.message = 'Email ou senha incorretos, tente novamente',
  ]);
}
...
class WeakPasswordException extends AuthException {
  WeakPasswordException([
    super.message = 'A senha é muito fraca. Use uma senha mais forte.',
  ]);
}
